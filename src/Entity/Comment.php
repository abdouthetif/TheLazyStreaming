...
class Comment
{
    ...
    {
        return $this->id_movie_tmdb;
    }

    public function setIdMovieTmdb(?int $id_movie_tmdb): self
    {
        $this->id_movie_tmdb = $id_movie_tmdb;
